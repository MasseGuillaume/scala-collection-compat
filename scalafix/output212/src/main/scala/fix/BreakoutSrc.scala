...
class BreakoutSrc(ts: Iterable[Int], vec: Vector[Int], list: List[Int], seq: Seq[Int]) {
  ...
  // immutable.SortedMap.from[Int, String](List(1 -> "1").iterator.map(x => x)): immutable.SortedMap[Int, String]
  // immutable.HashMap.from[Int, String](List(1 -> "1").iterator.map(x => x)): immutable.HashMap[Int, String]
  // immutable.ListMap.from[Int, String](List(1 -> "1").iterator.map(x => x)): immutable.ListMap[Int, String]
  // immutable.TreeMap.from[Int, String](List(1 -> "1").iterator.map(x => x)): immutable.TreeMap[Int, String]
  // mutable.SortedMap.from[Int, String](List(1 -> "1").iterator.map(x => x)): mutable.SortedMap[Int, String]
  // mutable.HashMap.from[Int, String](List(1 -> "1").iterator.map(x => x)): mutable.HashMap[Int, String]
  // mutable.ListMap.from[Int, String](List(1 -> "1").iterator.map(x => x)): mutable.ListMap[Int, String]
  // mutable.TreeMap.from[Int, String](List(1 -> "1").iterator.map(x => x)): mutable.TreeMap[Int, String]
  // mutable.Map.from[Int, String](List(1 -> "1").iterator.map(x => x)): mutable.Map[Int, String]
  // immutable.IntMap.from[String](List(1 -> "1").iterator.map(x => x)): immutable.IntMap[String]
  // immutable.LongMap.from[String](List(1L -> "1").iterator.map(x => x)): immutable.LongMap[String]
  // mutable.LongMap.from[String](List(1L -> "1").iterator.map(x => x)): mutable.LongMap[String]
}
